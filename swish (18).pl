...
avaliar_resultado :-
    ...
    !,
    write('====================================='), nl,
    write(' DERROTA - Voce foi derrotado...     '), nl,
    write('====================================='), nl.
...
avaliar_resultado :-
    ...
    !,
    write('====================================='), nl,
    write(' VITORIA - Voce derrotou 3 inimigos! '), nl,
    write('====================================='), nl.

mostrar_menu :-
    jogador(_, Vida, Arma, _, _, _, Dano),
    inimigos_derrotados(N),
    nl,
    write('-------------------------------------'), nl,
    write(' Vida: '),   write(Vida),  nl,
    ...
    write('-------------------------------------'), nl,
    write(' 1. Atacar inimigo                   '), nl,
    write(' 2. Explorar ambiente                 '), nl,
    write(' 3. Curar (+5 vida)                   '), nl,
    write(' 4. Pegar item                        '), nl,
    write(' 5. Ver status completo               '), nl,
    write('-------------------------------------'), nl,
    write('Escolha (1-5): ').

executar(1) :- acao_atacar,  !.
executar(2) :- acao_explorar, !.
executar(3) :- acao_curar,   !.
executar(4) :- acao_item,    !.
executar(5) :- relatorio,    !.
...
relatorio :-
    ...
    ver_historico,
    total_visitas(T),
    write('Total de locais visitados: '), write(T), nl,
    inimigos_derrotados(N),
    write('Inimigos derrotados: '), write(N), write('/3'), nl,
    write('=============================='), nl.